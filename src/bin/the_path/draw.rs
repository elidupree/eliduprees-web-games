  ...
  pub fn draw_object (&self, object: & Object, visible_radius: f64, speech_layer: bool) {
    ...
    match object.kind {
      ...
      Kind::Chest => {
        ...
        translate (position);
        js! {
          context.scale(@{scaled_radius});
          context.fillStyle = "rgb(255, 255, 255)";
          context.strokeStyle = "rgb(0, 0, 0)";
          context.lineWidth = @{scaled_radius}*0.1;
          var path = new Path2D("m 0.01270427,296.8216 c 0.0013367,-0.0357 0.0041607,-0.0615 0.03687345,-0.0885 0.05251228,-0.0385 0.05251228,-0.0385 0.06628589,-0.0523 0.0215214,-0.0212 0.0318517,-0.0431 0.0318517,-0.0661 0,-0.0506 -0.06112074,-0.0862 -0.1489281,-0.0862 -0.08005961,0 -0.14548467,0.0357 -0.14548467,0.0805 0,0.0247 0.0206606,0.0431 0.04734714,0.0431 0.02066059,0 0.03701683,-0.0104 0.03701683,-0.0236 0,-0.006 -0.0034432,-0.0127 -0.01119158,-0.0195 -0.01463452,-0.0138 -0.0117015,-0.0118 -0.0117015,-0.0199 0,-0.0212 0.03417912,-0.0388 0.07550018,-0.0388 0.05165137,0 0.07565972,0.0238 0.07565972,0.0669 0,0.0258 -0.0051648,0.0374 -0.0439037,0.0891 -0.03185169,0.0431 -0.04151605,0.0586 -0.04339341,0.11551 -6.6452e-4,0.0202 0.03330387,0.0203 0.03406778,-6e-5 z m -0.0130559525,0.0443 c -0.0275474575,0 -0.0490688475,0.0143 -0.0490688475,0.0322 0,0.0178 0.02152139,0.0322 0.04820793,0.0322 0.02668654,0 0.04820793,-0.0143 0.04820793,-0.0322 0,-0.0173 -0.02152139,-0.0322 -0.0473470125,-0.0322 z M -0.5,296.43257 C -0.498967,296.20113 -0.12639936,296.20001 -2.2774707e-4,296.2 0.12594386,296.19999 0.50057754,296.202 0.49954451,296.43248 Z m 0,0.0241 h 1 V 297 h -1 z");
          context.fill(path);
          context.stroke(path);
          context.restore();
        }
